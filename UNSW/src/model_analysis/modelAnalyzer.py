...
class ModelAnalyzer:
    ...
    def analyze_models(self, classes, model_type, depths, n_trees, X_train, y_train, X_test, y_test, samples_nature,
    ...
    def analyze_model_n_packets(self, npkts, outfile, force=False):
        ...
        X_train, y_train, sample_nat_train = self.get_x_y_flow(train_data, self.feats_important)
        X_test, y_test, sample_nat_test = self.get_x_y_flow(test_data, self.feats_important)
