...
# classes = ['Light Bulbs LiFX Smart Bulb', 'Netatmo weather station', 'Smart Things', 'Samsung SmartCam', 'Amazon Echo', 'Other']
# classes = ['Light Bulbs LiFX Smart Bulb', 'Netatmo weather station', 'Smart Things', 'Samsung SmartCam', 'Other']
# classes = ['Samsung SmartCam', 'Amazon Echo', 'Belkin wemo motion sensor', 'Other']
classes = ['Smart Things', 'PIX-STAR Photo-frame', 'Amazon Echo', 'Withings Aura smart sleep sensor', 'Light Bulbs LiFX Smart Bulb', 'Samsung SmartCam', 'Withings Smart Baby Monitor', 'Other']
...
# feats_important = ['tcp.window_size_value', 'ip.len', 'udp.length', 'srcport', 'dstport','ip.ttl', 'Packet Length Total']
# feats_important = ['tcp.window_size_value', 'srcport', 'tcp.hdr_len', 'dstport','ip.ttl', 'ip.len', 'udp.length']
# feats_important = ['ip.ttl', 'dstport', 'srcport', 'tcp.hdr_len', 'udp.length','ip.len', 'tcp.window_size_value',]
# feats_important = ['ip.ttl', 'dstport', 'srcport', 'udp.length', 'tcp.hdr_len', 'ip.len', 'tcp.window_size_value']
feats_important = ['ip.len', 'tcp.window_size_value', 'dstport', 'ip.ttl', 'srcport', 'udp.length']
...
for nd in range(2,5):
    ...
    f_name = "/home/nds-admin/UNSW_PCAPS/hyb_code/with_FL_Metric/cluster_model_analysis_results/unsw_models_"+str(nd)+"pkts_LinkageComplete_Cluster1.csv"
