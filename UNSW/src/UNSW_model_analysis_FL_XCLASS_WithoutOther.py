...
for nd in range(2,4):
    ...
    f_name = "/home/nds-admin/UNSW_PCAPS/hyb_code/with_FL_Metric/cluster_model_analysis_results/Proportional_fairness/unsw_models_"+str(nd)+"pkts_PF_WB_17CL_Cluster"+str(int(sys.argv[1])-1)+"_WithoutOther.csv"
