...
# print(pd.read_csv(sys.argv[2])['Class List'].to_list())
# print(int(sys.argv[1]))
# print(str(pd.read_csv(sys.argv[2])['Class List'].to_list()[int(sys.argv[1])-1]))
...
for nd in range(2,4):
    ...
    f_name = "/home/nds-admin/distributed_in_band/ToN-IoT/model_analysis_results/clustering_results/ton_models_"+str(nd)+"pkts_PF_WB_4CL_noTime_Cluster"+str(int(sys.argv[1])-1)+"_WithoutOther.csv"
